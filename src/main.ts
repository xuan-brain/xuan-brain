...
function updateVxeTableTheme(isDark: boolean) {
  ...
  if (isDark) {
    ...
    root.style.setProperty('--vxe-table-header-font-color', 'rgba(255, 255, 255, 0.7)');
    ...
    root.style.setProperty('--vxe-table-row-hover-background-color', 'rgba(255, 255, 255, 0.04)');
    root.style.setProperty('--vxe-table-row-striped-background-color', 'rgba(255, 255, 255, 0.02)');
    root.style.setProperty('--vxe-table-popup-border-color', '#424242');
    root.style.setProperty('--vxe-loading-background-color', 'rgba(0, 0, 0, 0.5)');
  } else {
    // Light theme
    ...
    root.style.setProperty('--vxe-table-row-striped-background-color', '#fafafa');
    root.style.setProperty('--vxe-table-popup-border-color', '#DADCE0');
    root.style.setProperty('--vxe-loading-background-color', 'rgba(255, 255, 255, 0.5)');
  }
}
