  ...
  >
    <v-card>
      ...
      <v-card-text>
        ...
        <v-alert type="info" density="compact" class="mt-4">
          <div class="text-caption">
            The PDF will be imported and metadata will be extracted automatically. You can edit the
      ...
      <v-card-actions>
        ...
        <v-btn color="primary" @click="handleSubmit" :loading="loading" :disabled="!selectedFile">
          Import
        </v-btn>
      </v-card-actions>
    </v-card>
